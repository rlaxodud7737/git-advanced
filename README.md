...
4. 브랜치 만들고, 전환까지 동시에 하기
  ...
  ### PUSH
   ...
   ### git revert
   - 이미 push 되어서 팀원간에 공유되고 있는 커밋을 되돌릴 땐 git reset 을 사용할 수 없습니다. 대신 git revert를 사용해야 합니다.
   - 'git revert'는 장애 상황을 해결할 때 많이 사용합니다. 장애를 유발시킨 코드가 들어가있는 커밋만 revet 시키고 다시 배포하는 식으로 장애를 빠르게 해결할 수 있습니다.